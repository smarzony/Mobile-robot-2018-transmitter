...
void read_button_neg_switch(uint8_t button, bool &state, jm_PCF8574 (*read_button_callback)(uint8_t))
{
...
void read_button_inc_switch(uint8_t button, uint8_t limit_min, uint8_t limit_max, uint8_t& state, jm_PCF8574 (*read_button_callback)(uint8_t))
{
  static unsigned long lastTime;
  unsigned long timeNow = millis();
  if (read_button_callback(button) == 0) {
